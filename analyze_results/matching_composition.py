# calculate the matching composition due to each method - results for the review rebuttal
...
# --- analysis of matching composition
...
df_baseline.rename(columns={
    ...
    'num_3cycles': 'baseline_num_3cycles',
    'num_1chains': 'baseline_num_1chains',
    'num_2chains': 'baseline_num_2chains',
...
df_clean["abs_diff_num_2cycles"] = df_clean["num_2cycles"] - df_clean["baseline_num_2cycles"]
